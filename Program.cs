...
Console.WriteLine($"The Repo Ranger v{Version}. By Racso. https://rac.so/ranger");
Console.WriteLine($"Licensed under the GNU General Public License v3.0: https://www.gnu.org/licenses/gpl-3.0.en.html");
